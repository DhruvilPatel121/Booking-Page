...
async function updateOrderAndBooking(
  sessionId: string,
  ...
  const items = order.items as Array<{ booking_id: string }>;
...
Deno.serve(async (req) => {
  try {
    ...
    const orderUpdated = await updateOrderAndBooking(sessionId, session);
